package com.food.ordering.system.order.service.applciation.rest;
...
public class OrderController {
    ...
    public ResponseEntity<TrackOrderResponse> trackOrderByTrackingId(@PathVariable UUID trackingId){
